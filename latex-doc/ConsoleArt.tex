...
\newglossaryentry{sdl2}{name={SDL2}, description={A cross-platform low-level multimedia library in C for handling graphics, input, audio, and window management}}
...
\begin{document}
	...
	\chapter{Core}
	\input{chapters/core/core.tex}
	
	\chapter{GUI}
	\input{chapters/sdl/sdl.tex}
	
	\chapter{Image formats}
	\input{chapters/images/images.tex}
