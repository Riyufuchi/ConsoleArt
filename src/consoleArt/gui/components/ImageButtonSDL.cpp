...
ImageButtonSDL::ImageButtonSDL(int x, int y, int width, int height, std::pair<SDL_Texture*, SDL_Texture*> texturePair) : ImageButtonSDL(x, y, width, height, texturePair.first, texturePair.second)
{
}
