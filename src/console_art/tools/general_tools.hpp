...
inline constexpr const char* CONSOLE_ART_VERSION = _CONSOLE_ART_VERSION;
inline void createManual()
{
...
inline std::string usedLibraries()
{
...
inline std::string aboutApplication()
{
...
inline void colorTest(consolelib::IConsole& console)
{
...
inline std::string createArgErrorMessage(const std::string& argument)
{
