...
#ifndef CONSOLE_ART_ABSTRACT_ABSTRACT_ASCII_PRINTER_H_
#define CONSOLE_ART_ABSTRACT_ABSTRACT_ASCII_PRINTER_H_
...
#endif /* CONSOLE_ART_ABSTRACT_ABSTRACT_ASCII_PRINTER_H_ */
