...
#include "abstract_ascii_conversion_state.h"

namespace consoleart {

AbstractAsciiConversionState::AbstractAsciiConversionState(Controller& controller, StateManager& stateManager) : AbstractState(controller, stateManager)
{
...
AbstractAsciiConversionState::~AbstractAsciiConversionState()
{
}

void AbstractAsciiConversionState::convertImageEvent(consoleartlib::AsciiConverter::CHAR_SETS charSet)
{
