...
#ifndef CONSOLE_ART_ABSTRACT_ABSTRACT_FILTER_STATE_H_
#define CONSOLE_ART_ABSTRACT_ABSTRACT_FILTER_STATE_H_
...
#endif /* CONSOLE_ART_ABSTRACT_ABSTRACT_FILTER_STATE_H_ */
